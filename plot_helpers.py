...
# 
def render_plot(ax, heading='', subtitle='', xlabel='', ylabel='', rotation=0, plotname='',displaybarlabel=True):
    
    plt.suptitle(heading, fontsize = 12)                        # main heading of the plot
    plt.title(subtitle, fontsize = 8)                          # sub title of the plot
